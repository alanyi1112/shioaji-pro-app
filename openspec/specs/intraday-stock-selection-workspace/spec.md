# intraday-stock-selection-workspace Specification

## Purpose
TBD - created by archiving change add-configurable-intraday-relative-volume-monitor. Update Purpose after archive.
## Requirements

# multiview-chart-viewport-stability Specification

## Purpose
TBD - created by archiving change stabilize-multiview-single-chart-viewport. Update Purpose after archive.
## Requirements

# multiview-tdcc-verified-archive-bootstrap Specification

## Purpose
TBD - created by archiving change accelerate-multiview-tdcc-holder-backfill-with-verified-archive. Update Purpose after archive.
## Requirements
